...
import { Alert, BackHandler, FlatList, InteractionManager, RefreshControl, ScrollView, View } from "react-native";
...
export default function DocumentsScreen() {
  ...
  useFocusEffect(
    useCallback(() => {
      let active = true;
      // After the drawer-close animation: the synchronous SQLite reads below
      // used to run on the same frame and made sidebar taps feel delayed.
